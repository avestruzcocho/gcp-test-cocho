#bnt-lakehouse-oro-prod
#ds_b_ant_oro

CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.a_predicciones_propension_prod`
(
  cliente_id INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_ant_prop_prod_calif_full`
(
cliente_id INT64,
fecha_informacion DATE,
prediccion_tdc FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_abandono_hip_hist_vxx`
(
cliente_id INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_abandono_hip_vxx`
(
cliente_id INT64,
credito_numero INT64,
obs DATE,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_abandono_total_hist_vxx`
(
cliente_id INT64,
fecha_informacion DATE,
prediccion FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_abandono_total_vxx`
(
cliente_id INT64,
fecha_informacion DATE,
prediccion FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_prop_prod_hist_vxx`
(
cliente_id INT64,
fecha_informacion DATE,
prediccion_tdc FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_prop_prod_vxx`
(
cliente_id INT64,
fecha_informacion DATE,
prediccion_tdc FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_calif_propension_multi_prod_hist_vxx`
(
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_entrenado_ins_prop_prod_vxx`
(
cliente_id INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_entrenado_prop_prod_hist`
(
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_entreno_sin_procesar_limpieza1_prop_prod`
(
cliente_id INT64,
fecha_obs DATE,
genero_femenino_bandera FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_entreno_sin_procesar_prop_prod`
(
cliente_id INT64 OPTIONS(description="Número de cliente"),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_abandono_hipo_hist`
(
fecha DATE,
version STRING,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_abandono_total_hist`
(
fecha DATE,
version STRING,
antiguedad INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_propension_prod_auto_hist`
(
fecha DATE,
version STRING,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_propension_prod_cn_hist`
(
fecha DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_propension_prod_fondos_hist`
(
fecha DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_propension_prod_hipo_hist`
(
fecha DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_importancia_caracteristicas_propension_prod_tdc_hist`
(
fecha DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_abn_hip_hist`
(
cliente_id INT64,
credito_numero INT64,
obs INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_abn_hip_vxx`
(
cliente_id INT64,
credito_numero INT64,
obs INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_abn_tot_hist`
(
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_abn_tot_vxx`
(
cliente_id INT64 OPTIONS(description="cliente"),
fecha_informacion INT64 OPTIONS(description="fecha_informacion"),
antiguedad INT64 OPTIONS(description="Antigüedad del cliente en meses"),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_prop_prod_hist`
(
cliente_id INT64 OPTIONS(description="Número de cliente"),
fecha_informacion INT64 OPTIONS(description="Fecha de información"),
genero_femenino_bandera FLOAT64 OPTIONS(description="Flag o indicadora si el cliente es mujer"),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_ins_prop_prod_vxx`
(
cliente_id INT64 OPTIONS(description="Número de cliente"),
fecha_informacion INT64 OPTIONS(description="Fecha de información"),
genero_femenino_bandera FLOAT64 OPTIONS(description="Flag o indicadora si el cliente es mujer"),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_metricas_abandono_hipo_hist`
(
fecha_informacion DATE,
roc_auc FLOAT64,
precision FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_metricas_abandono_total_hist`
(
fecha_informacion DATE,
roc_auc FLOAT64,
precision FLOAT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ant_metricas_prop_prod_hist`
(
fecha_informacion DATE,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_b_ejecucion_metrica_entrena_prop_prod`
(
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_import_carac_prop_prod_auto`
(
fecha_informacion DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_import_carac_prop_prod_cn`
(
fecha_informacion DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_import_carac_prop_prod_fondos`
(
fecha_informacion DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_import_carac_prop_prod_hipo`
(
fecha_informacion DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_import_carac_prop_prod_tdc`
(
fecha_informacion DATE,
version STRING,
genero_femenino_bandera INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_pred_abn_total_full`
(
cliente_id INT64 OPTIONS(description="cliente"),
fecha_informacion INT64 OPTIONS(description="fecha_informacion"),
antiguedad INT64 OPTIONS(description="Antigüedad del cliente en meses"),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_pred_abnd_hip_full`
(
cliente_id INT64,
credito_numero INT64,
obs INT64,
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_ant_oro.t_paso_pred_prop_prod_full`
(
cliente_id INT64 OPTIONS(description="Número de cliente"),
fecha_informacion INT64 OPTIONS(description="Fecha de información"),
genero_femenino_bandera FLOAT64 OPTIONS(description="Flag o indicadora si el cliente es mujer"),
...
#ds_b_dwh_cap_oro
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_dwh_cap_oro.t_b_dwh_cap_saldo_vista`
(
...
#ds_b_dwh_cat_oro
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_dwh_cat_oro.t_b_dwh_cat_segmentos`
(
...
#ds_b_dwh_cli_oro
CREATE TABLE `bnt-lakehouse-oro-prod.ds_b_dwh_cli_oro.t_b_dwh_cli_datos_basicos`
(
  numerocif_id INT64,
...
#ds_oro_generico
CREATE TABLE `bnt-lakehouse-oro-prod.ds_oro_generico.t_b_ant_adquisiciones_productos_observadas`
(
  cliente_id INT64 OPTIONS(description=""Número de cliente""),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_oro_generico.t_b_ant_fugas_hipotecario_observadas`
(
  cliente_id INT64 OPTIONS(description=""Número de cliente""),
...
CREATE TABLE `bnt-lakehouse-oro-prod.ds_oro_generico.t_b_ant_fugas_total_personal_observadas`
(
  cliente_id INT64 OPTIONS(description=""Número de cliente""),
