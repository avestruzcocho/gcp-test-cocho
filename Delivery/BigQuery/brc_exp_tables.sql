...
#ds_b_ant_brc
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.adquisiciones_productos_observadas`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.codigos_postales_mexico_ii`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.fugas_hipotecario_observadas`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.fugas_total_personal_observadas`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.insumos_abandono_hipoteca_hist`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_ant_brc.modelin`
(
num_clie FLOAT64 OPTIONS(description="Número de cliente"),
...
#ds_b_cap_brc
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_cap_brc.ctasactnom_opt`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_cli_brc.altamira_fusiones_fin_opt`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_cli_brc.altclientedim_sas_opt`
(
num_clie NUMERIC(8) OPTIONS(description="Número de cliente Altamira"),
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_cli_brc.altclienterelcuen_sas_opt`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_cli_brc.segmentos_clientes_opt`
(
num_clie NUMERIC(8) OPTIONS(description="Número de cliente Altamira"),
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_col_brc.perf_opt`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_dwh_cap_brc.altchequesfact_opt`
(
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_dwh_cat_brc.segmentocliendim_opt`
(
...
#ds_b_dwh_cli_brc
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_dwh_cli_brc.altclientedim_opt`
(
  numerocif STRING,
  pdimcliente NUMERIC,
  tipoperclav NUMERIC,
...
CREATE TABLE `bnt-lakehouse-brc-prod.ds_b_rie_brc.crm_base_ingresos_opt`
(
